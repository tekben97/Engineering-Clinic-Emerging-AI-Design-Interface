...
def detect_objects(input_image):
    ...
    subprocess.run(["python", r"Engineering-Clinic-Emerging-AI-Design-Interface\yolov7-main\detect.py", "--source", input_image, "--project", "run_images", "--name", "exp"])


    # Load the output image from your detection
    output_image = Image.open("run_images\\exp\\image.jpg")
    return output_image
